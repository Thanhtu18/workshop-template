...
* **Amazon RDS basics**
  ...
  * Tried simple application deployment and basic backup/restore

* **Database migration**
  * Got familiar with migration tools (SQL Server/Oracle → Aurora MySQL)
  * Checked logs, S3 data and handled some sample issues

* **Data Lake on AWS**
  * Created an S3 bucket, Glue crawler and data catalog
  * Queried data with Athena and viewed basic reports in QuickSight

* **Amazon DynamoDB**
  * Created DynamoDB tables and loaded sample data
  * Read and wrote data using the CLI and Console, checked backup options
