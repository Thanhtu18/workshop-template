...
* Practice access control, CloudFront integration, and versioning  
...
* **Amazon S3 Basics**
  * Understood what Amazon S3 is used for
  * Learned key concepts: buckets, objects, regions and storage for static websites

* **Created and Configured S3 Bucket**
  * Created an S3 bucket for static website hosting
  * Downloaded source code to the device and uploaded data to S3
  * Enabled the static website hosting feature on the bucket

* **Managed Public Access and Testing**
  * Configured S3 public access block settings
  * Set objects to be publicly accessible where needed
  * Opened and tested the static website URL

* **Integrated with Amazon CloudFront**
  * Blocked direct public access to the S3 bucket
  * Configured CloudFront distribution in front of the S3 website
  * Tested CloudFront URL for faster and more secure access

* **Used Versioning and Replication**
  * Enabled bucket versioning to track object changes
  * Moved objects between buckets/folders
  * Configured cross-Region replication for objects
