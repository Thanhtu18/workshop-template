...
6. [Simple and Secure Object Storage with Amazon S3](5.6-S3/)
7. [Accelerating Content Delivery with Amazon CloudFront (CDN)](5.7-CloudFront/)
8. [Managing User Identity and Access with Amazon Cognito](5.8-Cognito/)
9. [Managing Encryption Keys with AWS Key Management Service (KMS)](5.9-KeyManagementService/)
17. [SecretManager](5.17-SecretManager/)
18. [WAF](5.18-WAF/)